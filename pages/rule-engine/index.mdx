...
A lot of business revolves around policies. For example, eligibility of a user for a product would be a compliance policy. A credit policy would dictate if a user is eligible to get a loan.
